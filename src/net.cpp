...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SunflowerCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"23.245.55.64", "23.245.55.64"},
    {"23.245.55.83", "23.245.55.83"},
	{"107.183.21.66", "107.183.21.66"},
	{"107.183.21.196", "107.183.21.196"},
	{NULL,NULL},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SunflowerCoin is probably already running."), addrBind.ToString().c_str());
        else
